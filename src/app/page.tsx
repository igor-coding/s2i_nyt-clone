// TODO: Make separate components in files
...
import GetJokes from "@/components/getIndices";
            ...
            <form method="get" action="/search" className="hidden space-x-1">
              <div className="w-56 border rounded border-neutral-500 focus-within:border-1 focus-within:border-black focus-within:shadow dark:focus-within:border-white py-1 px-2 flex text-base">
                ...
                <input
                  type="reset"
                  value="CLEAR"
                  className="pl-2 text-[10px] text-neutral-400 cursor-pointer"
                />
              </div>
              <Button
                type="submit"
                className="text-[10px] font-bold bg-accent hover:bg-accentHover"
              >
                GO
              </Button>
            </form>
